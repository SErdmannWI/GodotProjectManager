...
public class EditJournalEntryRequest {
    ...
    public EditJournalEntryRequest() {}

    public EditJournalEntryRequest(EditJournalEntryRequest.Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public EditJournalEntryRequest build() {
            return new EditJournalEntryRequest(this);
        }
    }
}
